...
-- Table offres_cache (cache local des offres)
CREATE TABLE IF NOT EXISTS offres_cache (
    offre_id TEXT PRIMARY KEY,
    code TEXT UNIQUE NOT NULL,
    nom TEXT NOT NULL,
    description TEXT,
...
CREATE INDEX idx_offres_cache_statut ON offres_cache(statut);
CREATE INDEX idx_offres_cache_duree ON offres_cache(duree);
CREATE INDEX idx_offres_cache_prix ON offres_cache(prix);
CREATE INDEX idx_offres_cache_code ON offres_cache(code);
...
-- BASIC (4 offres)
-- ============================================================
('offre_basic_mensuel', 'BASIC_MENSUEL', 'Basic', 
 'Solution simple pour les petites structures', 'MENSUEL', 10000, 'XOF', 
 '{"users": 5, "storage": "10GB", "support": "standard"}', 0, 1),

('offre_basic_trimestriel', 'BASIC_TRIMESTRIEL', 'Basic Trimestriel', 
 'Économisez 10% sur votre abonnement Basic', 'TRIMESTRIEL', 27000, 'XOF', 
 '{"users": 5, "storage": "10GB", "support": "standard"}', 0, 2),

('offre_basic_annuel', 'BASIC_ANNUEL', 'Basic Annuel', 
 'Économisez 25% sur votre abonnement Basic', 'ANNUEL', 90000, 'XOF', 
 '{"users": 5, "storage": "10GB", "support": "standard"}', 0, 3),

('offre_basic_a_vie', 'BASIC_A_VIE', 'Basic À vie', 
 'Payez une fois, utilisez toujours - Basic', 'A_VIE', 250000, 'XOF', 
 '{"users": 5, "storage": "10GB", "support": "standard"}', 0, 4),

-- ============================================================
-- PREMIUM (4 offres)
-- ============================================================
('offre_premium_mensuel', 'PREMIUM_MENSUEL', 'Premium', 
 'Pour les établissements en croissance', 'MENSUEL', 25000, 'XOF', 
 '{"users": 20, "storage": "50GB", "support": "priority", "parents": true, "api": true}', 1, 5),

('offre_premium_trimestriel', 'PREMIUM_TRIMESTRIEL', 'Premium Trimestriel', 
 'Économisez 10% sur votre abonnement Premium', 'TRIMESTRIEL', 67500, 'XOF', 
 '{"users": 20, "storage": "50GB", "support": "priority", "parents": true, "api": true}', 0, 6),

('offre_premium_annuel', 'PREMIUM_ANNUEL', 'Premium Annuel', 
 'Économisez 25% sur votre abonnement Premium', 'ANNUEL', 225000, 'XOF', 
 '{"users": 20, "storage": "50GB", "support": "priority", "parents": true, "api": true}', 0, 7),

('offre_premium_a_vie', 'PREMIUM_A_VIE', 'Premium À vie', 
 'Payez une fois, utilisez toujours - Premium', 'A_VIE', 600000, 'XOF', 
 '{"users": 20, "storage": "50GB", "support": "priority", "parents": true, "api": true}', 0, 8),

-- ============================================================
-- GOLD (4 offres)
-- ============================================================
('offre_gold_mensuel', 'GOLD_MENSUEL', 'Gold', 
 'La solution premium avec support prioritaire et analytics avancés', 'MENSUEL', 35000, 'XOF', 
 '{"users": 50, "storage": "100GB", "support": "24/7", "parents": true, "api": true, "analytics": true}', 1, 9),

('offre_gold_trimestriel', 'GOLD_TRIMESTRIEL', 'Gold Trimestriel', 
 'Économisez 10% sur votre abonnement Gold', 'TRIMESTRIEL', 94500, 'XOF', 
 '{"users": 50, "storage": "100GB", "support": "24/7", "parents": true, "api": true, "analytics": true}', 0, 10),

('offre_gold_annuel', 'GOLD_ANNUEL', 'Gold Annuel', 
 'Économisez 25% sur votre abonnement Gold', 'ANNUEL', 315000, 'XOF', 
 '{"users": 50, "storage": "100GB", "support": "24/7", "parents": true, "api": true, "analytics": true}', 0, 11),

('offre_gold_a_vie', 'GOLD_A_VIE', 'Gold À vie', 
 'Payez une fois, utilisez toujours - Gold', 'A_VIE', 850000, 'XOF', 
 '{"users": 50, "storage": "100GB", "support": "24/7", "parents": true, "api": true, "analytics": true}', 0, 12);
